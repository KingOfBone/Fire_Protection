						...
						<div class='col-lg-6'>
							<div class="form-group">
								<div class="row">
									...
									<?php
										...
										echo "<select name='sensor' class='form-control'>";
							...
							<div class="form-group">
								<div class="row">
									...
									<div class="col-md-5">									
										<input  type="text" onKeyPress="return isNumberKeyTgl(event)" class="form-control datepicker" name="tgl_kejadian" value="<?php echo $row['tgl_kejadian']; ?>"  />
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								<div class="row">
									...
									<div class="col-md-5">									
										<input type="text" class="form-control" name="<?php echo $kol['name'] ?>" data-rule-required="true" value="<?php echo $row['keterangan_kejadian']; ?>" />
									</div>
								</div>
							</div>
