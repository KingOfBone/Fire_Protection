...
<?php
	...
	"select * from apar_2 a
	INNER JOIN `master`.login l
		on l.kodelogin = a.kode_kantor
	where a.kode_kantor in (
		select l.kodelogin from `master`.login l where l.kodeapp in (
			select l.kodeapp from `master`.login l where l.kodelogin = 5
		)
	);";
                                ...
                                <table class="table table-striped table-bordered table-hover" id="datatabel1">
									...
									?>
											<tr>
												...
												<td class="center">
													<a href="#" class="detail" data-id="<?php echo $row['id']; ?>" data-nama_table="<?php echo $nama_table; ?>" data-objek="panel" role="button" data-toggle="modal">
														<i class="glyphicon glyphicon-zoom-in fa-2x"></i>
													</a>
													<a href="#" class="detail_peta" data-id="<?php echo $row['id']; ?>" data-nama_table="<?php echo $nama_table; ?>" data-objek2="lokasi_panel" role="button" data-toggle="modal">
													...
													<a href="#" id="mau_delete=<?php echo "$nama_table_kecil,kode_panel,$row[id],".$nama_table_kecil."_lihat"; ?>" class="delete">
